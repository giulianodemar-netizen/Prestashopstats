{*
* PrestaShop Statistics Dashboard Template with Tabs and Charts
*
        ...
        <div class="row">
            <div class="col-lg-12">
                <form method="get" class="form-inline pull-right" id="stats-filter-form">
                    ...
                    <div class="form-group">
                        <label>{l s='Show Top' mod='prestashopstats'}:</label>
